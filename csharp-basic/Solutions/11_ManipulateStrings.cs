    ...
    */
    public class ManipulateTestMethodStrings
    {
        ...
        */
        ...
        /* 
            We can use the built-in string.Format method to format strings with variables. 
            Use the string.Format("abc {0} def {1}, variable, variable) syntax to 
            return the string "Hello to you too World"
        */
        ...
        */
        ...
        /* 
            The string type also has a built in method to check for null or empty strings. 
            Make the method CheckForNullOrEmpty return "Empty string" if the string "input" is null or empty, 
            and "Hello World" in any other case.
        */
        public string CheckForNullOrEmpty(string input)
        {
            return string.IsNullOrEmpty(input) ? "Empty string" : "Hello World";
        }
    }
}
