...
namespace Solutions
{
    public class Iterators
    {
         ...
         * This methods returns an IEnumerator. 
         */
        ...
        /*
        * Use "yield return" to return numbers from 0 to 9 in sequence. 
        * This methods returns an IEnumerable. 
        */
        ...
        {
            return days.Where(day => day != "Thr" && day != "Fri" && day != "Sat");
            //Optional return days.TakeWhile(day => day != "Thr" && day != "Fri" && day != "Sat");
        }
